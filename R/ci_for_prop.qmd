...
**The {cardx} package** includes waldcc, wald, clopper-pearson, wilson, wilsoncc, strat_wilson, strat_wilsoncc, agresti-coull and jeffreys methods for one-sample proportions
...
**The {ratesci} package** produces a variety of CIs for a proportion, including ... \[TBC\] - note, the current development version at <https://github.com/petelaud/ratesci> has new features in the rateci() function for a single proportion (including more of the CI methods described below) compared to the CRAN release.
